...
public class AnnotationConfiguredStereotype extends AbstractStereotype {
	...
	public static <T> org.jmolecules.stereotype.api.Stereotype of(String fullyQualifiedName, Stereotype annotation) {
		...
		org.jmolecules.stereotype.api.Stereotype stereotype = new AnnotationConfiguredStereotype(
				StringBasedStereotype.of(fullyQualifiedName), annotation);

		return CachingStereotype.of(stereotype);
	}
