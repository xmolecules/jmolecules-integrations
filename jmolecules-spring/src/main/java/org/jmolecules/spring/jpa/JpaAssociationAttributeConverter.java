...
/**
 * JPA flavor of {@link AssociationAttributeConverter}.
 *
 * @author Oliver Drotbohm
 */
public class JpaAssociationAttributeConverter<T extends AggregateRoot<T, ID>, ID extends Identifier, S>
		extends AssociationAttributeConverter<T, ID, S>
		implements AttributeConverter<Association<T, ID>, S> {

	/**
	 * Creates a new {@link JpaAssociationAttributeConverter} for the given id type.
	 *
